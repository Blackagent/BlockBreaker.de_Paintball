                ...
                Bukkit.getScheduler().scheduleAsyncRepeatingTask(Paintball.getInstance(), new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(Data.counter == 60 || Data.counter == 45 || Data.counter == 30 || Data.counter == 20 || Data.counter == 10 || Data.counter == 3 || Data.counter == 2) {
                            ...
                            Bukkit.getOnlinePlayers().forEach(player -> player.playSound(player.getLocation(), Sound.NOTE_PLING, 1, 75)); //TODO: Richtigen Sound auswählen
                        }
                        ...
                        if(Data.counter == 0) {
                            ...
                            Bukkit.getOnlinePlayers().forEach(player -> player.playSound(player.getLocation(), Sound.NOTE_PLING, 2, 75)); //TODO: Richtigen Sound auswählen
